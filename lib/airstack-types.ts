...
export type TrendingsMintsQueryVariables = Exact<{
  timeFrame: TimeFrame;
  criteria: TrendingMintsCriteria;
  address: Scalars["Address"]["input"];
}>;

export type TrendingsMintsQuery = {
  TrendingMints: {
    TrendingMint: Array<{
      address: string | null;
...
export type NftDetailQuery = {
  TokenNfts: {
    TokenNft: Array<{
      ...
      contentValue: { image: { medium: string | null } | null } | null;
      metaData: { name: string | null; description: string | null } | null;
    }> | null;
  } | null;
};
